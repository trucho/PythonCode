...
# This function directly reads the fsa file, but then things have to be parsed out.
#Might as well just rely on storing.inds fragman function, since it's a good parser.

jread.abif <- function(filename, max.bytes.in.file = file.info(filename)$size, 
...
test = jread.abif("/Users/angueyraaristjm/Documents/Python/PythonCode/fatools-master/test.fsa")
