...
# nFeatures = 500
#        ndim = 24, res = 1 -> c = 10; 
               # one big cluster expresses syt5a and gnat2 with a few rods inside: immature photoreceptors
...
FeaturePlot(photo, reduction = 'tsne', features = c("opn1sw1", "opn1sw2",'opn1mw1','opn1mw2','opn1mw3','opn1mw4','opn1lw1','opn1lw2','si:busm1-57f23.1','gnat1','nr2e3','gnat2'))
FeaturePlot(photo, reduction = 'tsne', features = c("rho", "nr2e3","nr2f6b","crx",'syt5a','syt5b', 'gnat1','gnat2'))
FeaturePlot(photo, reduction = 'tsne', features = c("otx5","tbx2a","tbx2b","rxrgb"))
